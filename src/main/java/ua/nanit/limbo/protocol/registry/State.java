    ...
    CONFIGURATION(3) {
        {
            ...
            clientBound.register(
                    ...
                    map(0x0E, V1_20_5, V1_21_5)
            );
            clientBound.register(
                    PacketUpdateTags::new,
                    map(0x0D, V1_20_5, V1_21_5)
            );
            clientBound.register(
