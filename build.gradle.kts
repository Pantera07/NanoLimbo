...
dependencies {
    ...
    implementation("io.netty:netty-transport-native-epoll:4.2.10.Final:linux-aarch_64")
    implementation("io.netty:netty-transport-native-io_uring:4.2.10.Final:linux-x86_64")
    implementation("io.netty:netty-transport-native-io_uring:4.2.10.Final:linux-aarch_64")
    implementation("io.netty:netty-transport-native-kqueue:4.2.10.Final:osx-x86_64")
    implementation("io.netty:netty-transport-native-kqueue:4.2.10.Final:osx-aarch_64")
